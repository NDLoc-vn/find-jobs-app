...
//             <div
//               key={candidate.id}
//               className="flex justify-between place-items-center border p-4 rounded-lg shadow-md mb-3"
//             >
...
//                   <p>Ngày nộp: {candidate.date}</p>
//                 </div>
//               </div>
//               <div
//                 className={`px-4 py-1 rounded-full text-white ${candidate.statusColor}`}
//               >
//                 {candidate.status}
//               </div>
//               <div>
...
//                   className="text-blue-600 border border-blue-600 px-4 py-2 rounded-lg hover:bg-blue-600 hover:text-white mr-2"
//                 >
//                   Xem CV
//                 </a>
//                 <a
