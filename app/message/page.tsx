...
const MessagesPage: React.FC = () => {
  const [users] = useState<User[]>([
    { id: 1, name: 'Huy Hoàng', avatar: '/avatar_temp.jpg', lastMessage: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit' },
    { id: 2, name: 'Văn B', avatar: '/avatar_temp.jpg', lastMessage: 'Fusce vel massa ac felis porta auctor gravida ut lacus' },
    { id: 3, name: 'Cẩm Tú', avatar: '/avatar_temp.jpg', lastMessage: 'Ut id urna euismod, faucibus quam ac, eleifend arcu' },
  ]);

  const [messages, setMessages] = useState<Message[]>([
    { id: 1, message: 'Fusce non bibendum magna, sed lacinia metus. Mauris rutrum ex et euismod congue. Integer congue laoreet bibendum. Nulla sit amet efficitur lorem, eu molestie sapien. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut ac justo iaculis, laoreet lectus a, fringilla orci. Nulla sapien neque, rhoncus nec lorem vel, fringilla vestibulum ligula.', sender: 'recruiter', avatar: '/avatar_temp.jpg' },
    { id: 2, message: 'Lorem Ipsum', sender: 'user', avatar: '/avatar_temp.jpg' },
  ]);
      ...
      <div className="flex h-[calc(100vh-5rem)]">
        ...
        <div className="w-3/4 flex flex-col">
          <div className="p-4 border-b flex items-center">
            <img src={selectedUser?.avatar} alt="avatar" className="w-10 h-10 rounded-full mr-2" />
